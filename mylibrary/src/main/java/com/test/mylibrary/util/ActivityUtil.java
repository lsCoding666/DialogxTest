...
public class ActivityUtil {
    ...
    public static void startActivityForResult(
            @SuppressWarnings("rawtypes") Class classes, int requestCode) {
    ...
    public static void startActivity(
            @SuppressWarnings("rawtypes") Class classes, boolean isFinish) {
     ...
     */
    public static void startActivity(
            @SuppressWarnings("rawtypes") Class classes, HashMap<String, String> hashMap) {
