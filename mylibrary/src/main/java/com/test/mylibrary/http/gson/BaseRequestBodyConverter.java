...
/**
 * @Author 许朋友爱玩 @Date 2020/6/10 @Github https://github.com/LoveLifeEveryday @JueJin
 * https://juejin.im/user/5e429bbc5188254967066d1b/posts @Description BaseRequestBodyConverter
 */
public class BaseRequestBodyConverter<T> implements Converter<T, RequestBody> {

    private static final MediaType MEDIA_TYPE =
            MediaType.parse(XUtil.getApplication().getString(R.string.MEDIA_TYPE));
